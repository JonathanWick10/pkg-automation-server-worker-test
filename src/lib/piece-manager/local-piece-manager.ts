...
import { ApLock, CacheState, filePiecesUtils, memoryLock } from 'automation-server-shared-test'
import { assertEqual, assertNotNullOrUndefined, isEmpty, PackageType, PiecePackage } from 'automation-shared-test'
...
export class LocalPieceManager extends PieceManager {
    ...
    protected override async installDependencies(
        ...
        try {
            ...
            await linkPackages(projectPath, join(baseLinkPath, 'framework'), 'automation-pieces-framework-test', frameworkPackages, params.log)
